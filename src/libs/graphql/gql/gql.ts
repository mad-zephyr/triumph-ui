...
const documents: Documents = {
  ...
  '\n  \n  fragment CarouselSectionFragment on ComponentSectionCarousel {\n    id\n    __typename\n    image {\n      ...UploadFileFragment\n    }\n  }\n':
    types.CarouselSectionFragmentFragmentDoc,
  '\n  \n  fragment CategoryAccordionFragment on ComponentSectionAccordionSection {\n    __typename\n    active\n    title\n    Cards {\n      __typename\n      show\n      title\n      button {\n        __typename\n        title\n        url\n        variant\n      }\n      cover {\n        ...UploadFileFragment\n      }\n    }\n  }\n':
  ...
  '\n  \n  query GET_BIKES_TYPE_PAGE($locale: I18NLocaleCode!) {\n    bikeTypesPage(locale: $locale) {\n      __typename\n      navigator_title\n      id: documentId\n      displayed_bike_types {\n        title\n        type\n        motorcycles {\n          model_name\n          base_price\n          sku\n          bikes_type {\n            __typename\n            ... on BikesType {\n              type\n              title\n            }\n          }\n          listing_image {\n            ...UploadFileFragment\n          }\n        }\n      }\n    }\n  }\n':
    types.Get_Bikes_Type_PageDocument,
  '\n  \n  \n  \n  \n  query GetNewsPageQuery($locale: I18NLocaleCode!, $url: String!) {\n    newsPosts(\n      locale: $locale\n      filters: { url: { eq: $url } }\n      status: PUBLISHED\n    ) {\n      __typename\n      title\n      previewText\n      url\n      id: documentId\n      preview_cover {\n        ...UploadFileFragment\n      }\n      sections {\n        ...TitleSectionFragment\n        ...TextRedactorSection\n        ...CarouselSectionFragment\n      }\n    }\n  }\n':
